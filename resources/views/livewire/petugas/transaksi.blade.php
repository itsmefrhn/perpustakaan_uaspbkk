<div class="row">
    ...
    <div class="card-tools">
        ...
        <input wire:model="search" type="search" name="table_search" class="form-control float-right" placeholder="Cari Transaksi">
        ...
        <tr>
            ...
            <td>
                @if ($item->status == 1)
                <span wire:click="pinjam({{$item->id}})" class="btn btn-sm btn-success">Pinjam</span>
                @elseif ($item->status == 2)
                <span wire:click="kembali({{$item->id}})"class="btn btn-sm btn-primary">Kembali</span>
                @endif
            </td>
            @else
